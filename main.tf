...
resource "azurerm_cosmosdb_account" "db" {
  ...
  tags = {
    ...
    git_org     = "bala988"
    yor_trace   = "e526da1a-f1e5-436e-b292-8c307747c560"
  }
}
...
resource "azurerm_storage_account" "storage_account" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "ef5d4400-c97f-4129-bb5c-7040e1ef7a31"
  }
}
...
resource "azurerm_app_service_plan" "app_service_plan" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "c82dcf4e-097d-4529-9dca-6c78c5d8b938"
  }
}
...
resource "azurerm_function_app" "function_app" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "577259c8-a49f-4472-98f1-05ce29ed352b"
  }
}
...
resource "azurerm_network_security_group" "net_sg" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "30074386-4b9c-4d4c-89c8-5916e444976b"
  }
}
...
resource "azurerm_virtual_network" "vNet" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "1a72b8ef-a94d-4889-bbf7-b8ee3ab47678"
  }
}
...
resource "azurerm_public_ip" "VM_PublicIP" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "a36369e3-5208-48b1-a1b0-33d675369c80"
  }
}
...
resource "azurerm_network_interface" "net_int" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "359bc6ed-3e33-4ac8-b98f-4cb7911716f7"
  }
}
...
resource "azurerm_virtual_machine" "dev-vm" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "41c69e24-3d73-4331-bf50-c23684fed90c"
  }
}
...
tags = {
  environment = "production"
  git_org     = "bala988"
  yor_trace   = "543927fd-def0-4217-8805-54e4118463e7"
}
}
...
resource "azurerm_user_assigned_identity" "user_id" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "dd5c329c-fae4-4e18-8f63-91602751010d"
  }
}
...
resource "azurerm_automation_account" "dev_automation_account_test" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "f709f8fc-c7a2-45d0-a847-e21cff92fa3c"
  }
}
...
resource "azurerm_automation_runbook" "dev_automation_runbook" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "66c677c1-0e1e-4e8f-b248-250096255a15"
  }
}
...
resource "azurerm_function_app" "function_app_front" {
  ...
  tags = {
    environment = "production"
    git_org     = "bala988"
    yor_trace   = "a460d3e1-e422-4dfc-8861-f452b71d1f14"
  }
}
